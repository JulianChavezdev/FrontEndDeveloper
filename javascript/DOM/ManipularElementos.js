...
// Mostramos en consola el nombre de la clase (o clases) que tiene el elemento 'input' console.dir(input.className); // Mostramos el atributo 'id' del elemento 'input' en la consola console.dir(input.id);